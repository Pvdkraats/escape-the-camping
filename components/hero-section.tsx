...
import { Mail, Menu, SendHorizonal, X, Caravan } from 'lucide-react'
                    ...
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-20">
                        <div className="lg:flex lg:items-center lg:gap-12">
                            <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                ...
                                <h1 className="mt-10 text-balance text-4xl font-bold md:text-6xl xl:text-6xl">Escape <br /> The <br /> Camping</h1>
                                <p className="mt-8">Los spannende puzzels en opdrachten op met het hele gezin en ontsnap samen van de camping!</p>
                                        ...
                                        <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[calc(var(--radius)+0.75rem)] border pr-3 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                                            ...
                                            <div className="md:pr-1.5 lg:pr-0">
                                                <Button
                                                    ...
                                                    <span className="hidden md:block">Start your escape now</span>
                                                    <SendHorizonal
